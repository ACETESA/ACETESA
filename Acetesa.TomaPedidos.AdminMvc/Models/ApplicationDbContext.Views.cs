...
[assembly: DbMappingViewCacheTypeAttribute(
    typeof(Acetesa.TomaPedidos.AdminMvc.Models.ApplicationDbContext),
    typeof(Edm_EntityMappingGeneratedViews.ViewsForBaseEntitySetsddbc11b307879b901bd1c4453256322cfcd00ba9a16b13664fe88bd88769282e))]
...
namespace Edm_EntityMappingGeneratedViews
{
    ...
    internal sealed class ViewsForBaseEntitySetsddbc11b307879b901bd1c4453256322cfcd00ba9a16b13664fe88bd88769282e : DbMappingViewCache
    {
        /// <summary>
        ...
        {
            get { return "ddbc11b307879b901bd1c4453256322cfcd00ba9a16b13664fe88bd88769282e"; }
        }
    ...
    SELECT VALUE -- Constructing Roles
        [Acetesa.TomaPedidos.AdminMvc.Models.IdentityRole](T1.IdentityRole_Id, T1.IdentityRole_Name)
    FROM (
        SELECT 
            T.Id AS IdentityRole_Id, 
            T.Name AS IdentityRole_Name, 
    ...
    SELECT VALUE -- Constructing IdentityUserRoles
        [Acetesa.TomaPedidos.AdminMvc.Models.IdentityUserRole](T1.IdentityUserRole_UserId, T1.IdentityUserRole_RoleId)
    FROM (
        SELECT 
            T.UserId AS IdentityUserRole_UserId, 
            T.RoleId AS IdentityUserRole_RoleId, 
    ...
    SELECT VALUE -- Constructing Users
        [Acetesa.TomaPedidos.AdminMvc.Models.ApplicationUser](T1.ApplicationUser_Id, T1.ApplicationUser_Email, T1.ApplicationUser_EmailConfirmed, T1.ApplicationUser_PasswordHash, T1.ApplicationUser_SecurityStamp, T1.ApplicationUser_PhoneNumber, T1.ApplicationUser_PhoneNumberConfirmed, T1.ApplicationUser_TwoFactorEnabled, T1.ApplicationUser_LockoutEndDateUtc, T1.ApplicationUser_LockoutEnabled, T1.ApplicationUser_AccessFailedCount, T1.ApplicationUser_UserName)
    FROM (
        SELECT 
            T.Id AS ApplicationUser_Id, 
            T.Email AS ApplicationUser_Email, 
    ...
    SELECT VALUE -- Constructing IdentityUserClaims
        [Acetesa.TomaPedidos.AdminMvc.Models.IdentityUserClaim](T1.IdentityUserClaim_Id, T1.IdentityUserClaim_UserId, T1.IdentityUserClaim_ClaimType, T1.IdentityUserClaim_ClaimValue)
    FROM (
        SELECT 
            T.Id AS IdentityUserClaim_Id, 
            T.UserId AS IdentityUserClaim_UserId, 
    ...
    SELECT VALUE -- Constructing IdentityUserLogins
        [Acetesa.TomaPedidos.AdminMvc.Models.IdentityUserLogin](T1.IdentityUserLogin_LoginProvider, T1.IdentityUserLogin_ProviderKey, T1.IdentityUserLogin_UserId)
    FROM (
        SELECT 
            T.LoginProvider AS IdentityUserLogin_LoginProvider, 
            T.ProviderKey AS IdentityUserLogin_ProviderKey, 
