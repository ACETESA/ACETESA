...
{
    public class CotizacionFindViewModel
    {
        ...
        public IEnumerable<CotizacionListadoModel> CotizacionModels { get; set; }
        public PagedList.IPagedList<CotizacionListadoModel> PagedListListaEntity { get; set; }
        public EstadoCotizacionTypes Estado { get; set; }
